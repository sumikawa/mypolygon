...
use mypolygon::triangle::{Triangle, Vec3, Vertex};
...
fn main() {
    ...
    let tri = Triangle {
        v0: Vertex {
            pos: Vec3 { x: 129.7, y: -26.4, z: 0.0 },
            z: 1.0,
            color: Color::new(0.0, 0.0, 1.0),
        },
        v1: Vertex {
            pos: Vec3 { x: 1327.3, y: 480.1, z: 0.0 },
            z: 1.0,
            color: Color::new(0.0, 1.0, 0.0),
        },
        v2: Vertex {
            pos: Vec3 { x: 124.0, y: 841.0, z: 0.0 },
            z: 1.0,
    ...
    let tri = Triangle {
        v0: Vertex {
            pos: Vec3 { x: 1412.7, y: -26.4, z: 0.0 },
            z: 1.5,
            color: Color::new(0.0, 0.0, 0.5),
        },
        v1: Vertex {
            pos: Vec3 { x: -55.3, y: 280.1, z: 0.0 },
            z: 0.1,
            color: Color::new(1.0, 1.0, 0.0),
        },
        v2: Vertex {
            pos: Vec3 { x: 1033.0, y: 841.0, z: 0.0 },
            z: 1.3,
